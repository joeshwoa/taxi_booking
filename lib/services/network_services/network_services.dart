...
class NetworkServices {
  ...
  static Future<Map<String, dynamic>> requestTaxi (TaxiBookingDetailsModel taxiBookingDetailsModel, TaxiBookingSummaryModel taxiBookingSummaryModel) async {
    ...
    map['dog'] = taxiBookingDetailsModel.dogCount??0;
    map['cat'] = taxiBookingDetailsModel.catCount??0;

    map['note'] = 'Passenger Comment:\n${taxiBookingDetailsModel.passengerComment??''}\nLuggages Comment:\n${taxiBookingDetailsModel.luggagesComment??''}\nSpecial Luggages Comment:\n${taxiBookingDetailsModel.specialLuggagesComment??''}\nPet Comment:\n${taxiBookingDetailsModel.petComment??''}';

    map['price'] = taxiBookingSummaryModel.totalPrice;

    if(taxiBookingSummaryModel.promoCode != null) {
    ...
    request.headers['Authorization'] = "Bearer ${dotenv.env['TEST_ACCESS_TOKEN']}";
